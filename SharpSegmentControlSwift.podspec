...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/nattaponGolf123/SharpSegmentControlSwift'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nattaponGolf123' => 'taponpa@gmail.com' }
  s.source           = { :git => 'https://github.com/nattaponGolf123/SharpSegmentControlSwift.git', :tag => s.version.to_s }
